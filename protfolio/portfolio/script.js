document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupTypewriter() {
        ...
        const typewriter = new TypeWriter(
            typewriterElement,
            `const Akash Srirangam: Array<Ingredient> = [
    Designer,
    Developer, 
    ...everythingNice
];`,
...
// language  
const texts = ["தமிழ் என் தாய்மொழி ", "English I Speak Fluently ","ഞാൻ കുറച്ച് മലയാളം സംസാരിക്കും"]
...
let workExperienceData = [
    ...
    { startYear: 2022, endYear: 2023, title: "fullstack Trainee", description: "CODSOFT (Online), India" }
];
...
// Education Data
const educationData = [
    { date: "2023 - 2024", title: "Fullstack Course", description: "Qspider, Velachery, Chennai-69, India" },
    { date: "2019 - 2023", title: "Bachelor's in Electrical and Electronics Engineering", description: "Imayam college of engineering,Thuraiyur,Trichy,India" },
    { date: "2018 - 2019", title: "Higher Secondary Education", description: "Government Boys Higher Secondary School, Pattukottai, India" },
    { date: "2016 - 2017", title: "Secondary Education", description: "Government high school kondraikkadu,Peravurani,Thanjavur, India" }
];
